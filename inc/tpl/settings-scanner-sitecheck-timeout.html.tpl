...
<div class="sucuriscan-panel">
    <h3 class="sucuriscan-title">Malware Scanner Timeout</h3>
    ...
    <div class="inside">
        ...
        <div class="sucuriscan-inline-alert-info">
            <p>
                You can set up to %%SUCURI.MaxRequestTimeout%% seconds for the timeout,
        ...
        <form action="%%SUCURI.URL.Settings%%#scanner" method="post">
            ...
            <fieldset class="sucuriscan-clearfix">
                ...
                <input type="text" name="sucuriscan_sitecheck_timeout" />
