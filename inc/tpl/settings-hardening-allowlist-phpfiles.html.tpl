    ...
    <div class="inside">
        ...
        <form action="%%SUCURI.URL.Settings%%#hardening" method="post">
            ...
            <fieldset class="sucuriscan-clearfix">
                ...
                <input type="text" name="sucuriscan_hardening_allowlist" placeholder="e.g. wp-tinymce.php"
                       data-cy="sucuriscan_hardening_allowlist_input"/>
                <button type="submit" class="button button-primary"
                        data-cy="sucuriscan_hardening_allowlist_submit">{{Submit}}</button>
            </fieldset>
        </form>
        ...
        <form action="%%SUCURI.URL.Settings%%#hardening" method="post">
            ...
            <table class="wp-list-table widefat sucuriscan-table sucuriscan-hardening-allowlist-table">
                ...
                <td id="cb" class="manage-column column-cb check-column">
                    ...
                    <input id="cb-select-all-1" data-cy="sucuriscan_hardening_select_all" type="checkbox">
                </td>
            ...
            <button type="submit" class="button button-primary"
                    data-cy="sucuriscan_hardening_remove_allowlist_submit">{{Delete}}</button>
        </form>
    </div>
</div>
