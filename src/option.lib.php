...
class SucuriScanOption extends SucuriScanRequest
{
    ...
    private static function getDefaultOptionValues()
    {
        $defaults = array(
			...
			'sucuriscan_cache_option_front_page_max_age' => 21600,
			'sucuriscan_cache_option_front_page_s_maxage' => 0,
			'sucuriscan_cache_option_front_page_stale_if_error' => 0,
			'sucuriscan_cache_option_front_page_stale_while_revalidate' => 0,
			'sucuriscan_cache_option_front_page_pagination_factor' => 'unavailable',
			'sucuriscan_cache_option_front_page_old_age_multiplier' => 'unavailable',

			'sucuriscan_cache_option_posts_max_age' => 43200,
			'sucuriscan_cache_option_posts_s_maxage' => 0,
			'sucuriscan_cache_option_posts_stale_if_error' => 0,
			'sucuriscan_cache_option_posts_stale_while_revalidate' => 0,
			'sucuriscan_cache_option_posts_pagination_factor' => 0,
			'sucuriscan_cache_option_posts_old_age_multiplier' => true,

			'sucuriscan_cache_option_pages_max_age' => 86400,
			'sucuriscan_cache_option_pages_s_maxage' => 0,
			'sucuriscan_cache_option_pages_stale_if_error' => 0,
			'sucuriscan_cache_option_pages_stale_while_revalidate' => 0,
			'sucuriscan_cache_option_pages_pagination_factor' => 0,
			'sucuriscan_cache_option_pages_old_age_multiplier' => 'unavailable',

			'sucuriscan_cache_option_main_index_max_age' => 21600,
			'sucuriscan_cache_option_main_index_s_maxage' => 0,
			'sucuriscan_cache_option_main_index_stale_if_error' => 0,
			'sucuriscan_cache_option_main_index_stale_while_revalidate' => 0,
			'sucuriscan_cache_option_main_index_pagination_factor' => 5,
			'sucuriscan_cache_option_main_index_old_age_multiplier' => 'unavailable',

			'sucuriscan_cache_option_categories_max_age' => 86400,
			'sucuriscan_cache_option_categories_s_maxage' => 0,
			'sucuriscan_cache_option_categories_stale_if_error' => 0,
			'sucuriscan_cache_option_categories_stale_while_revalidate' => 0,
			'sucuriscan_cache_option_categories_pagination_factor' => 8,
			'sucuriscan_cache_option_categories_old_age_multiplier' => 'unavailable',

			'sucuriscan_cache_option_tags_max_age' => 86400,
			'sucuriscan_cache_option_tags_s_maxage' => 0,
			'sucuriscan_cache_option_tags_stale_if_error' => 0,
			'sucuriscan_cache_option_tags_stale_while_revalidate' => 0,
			'sucuriscan_cache_option_tags_pagination_factor' => 10,
			'sucuriscan_cache_option_tags_old_age_multiplier' => 'unavailable',

			'sucuriscan_cache_option_authors_max_age' => 86400,
			'sucuriscan_cache_option_authors_s_maxage' => 0,
			'sucuriscan_cache_option_authors_stale_if_error' => 0,
			'sucuriscan_cache_option_authors_stale_while_revalidate' => 0,
			'sucuriscan_cache_option_authors_pagination_factor' => 10,
			'sucuriscan_cache_option_authors_old_age_multiplier' => 'unavailable',

			'sucuriscan_cache_option_dated_archives_max_age' => 86400,
			'sucuriscan_cache_option_dated_archives_s_maxage' => 0,
			'sucuriscan_cache_option_dated_archives_stale_if_error' => 0,
			'sucuriscan_cache_option_dated_archives_stale_while_revalidate' => 0,
			'sucuriscan_cache_option_dated_archives_pagination_factor' => 0,
			'sucuriscan_cache_option_dated_archives_old_age_multiplier' => 'unavailable',

			'sucuriscan_cache_option_feeds_max_age' => 21600,
			'sucuriscan_cache_option_feeds_s_maxage' => 0,
			'sucuriscan_cache_option_feeds_stale_if_error' => 0,
			'sucuriscan_cache_option_feeds_stale_while_revalidate' => 0,
			'sucuriscan_cache_option_feeds_pagination_factor' => 0,
			'sucuriscan_cache_option_feeds_old_age_multiplier' => 'unavailable',

			'sucuriscan_cache_option_attachment_pages_max_age' => 86400,
			'sucuriscan_cache_option_attachment_pages_s_maxage' => 0,
			'sucuriscan_cache_option_attachment_pages_stale_if_error' => 0,
			'sucuriscan_cache_option_attachment_pages_stale_while_revalidate' => 0,
			'sucuriscan_cache_option_attachment_pages_pagination_factor' => 0,
			'sucuriscan_cache_option_attachment_pages_old_age_multiplier' => 'unavailable',

			'sucuriscan_cache_option_search_results_max_age' => 86400,
			'sucuriscan_cache_option_search_results_s_maxage' => 0,
			'sucuriscan_cache_option_search_results_stale_if_error' => 0,
			'sucuriscan_cache_option_search_results_stale_while_revalidate' => 0,
			'sucuriscan_cache_option_search_results_pagination_factor' => 0,
			'sucuriscan_cache_option_search_results_old_age_multiplier' => 'unavailable',

			'sucuriscan_cache_option_404_not_found_max_age' => 86400,
			'sucuriscan_cache_option_404_not_found_s_maxage' => 0,
			'sucuriscan_cache_option_404_not_found_stale_if_error' => 0,
			'sucuriscan_cache_option_404_not_found_stale_while_revalidate' => 0,
			'sucuriscan_cache_option_404_not_found_pagination_factor' => 0,
			'sucuriscan_cache_option_404_not_found_old_age_multiplier' => 'unavailable',

            'sucuriscan_cache_option_permanent_redirects_max_age' => 86400,
            'sucuriscan_cache_option_permanent_redirects_s_maxage' => 0,
            'sucuriscan_cache_option_permanent_redirects_stale_if_error' => 0,
            'sucuriscan_cache_option_permanent_redirects_stale_while_revalidate' => 0,
            'sucuriscan_cache_option_permanent_redirects_pagination_factor' => 0,
            'sucuriscan_cache_option_permanent_redirects_old_age_multiplier' => 'unavailable',
        );
